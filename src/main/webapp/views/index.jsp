					...
					<nav id="navbar">
						<div class="main-menu stellarnav">
							<ul class="menu-list">
								...
								<li class="menu-item"><a href="/noticelist.go" class="nav-link" data-effect="Shop">공지사항</a></li>
...
<section id="quotation" class="align-center">
	<div class="inner-content">
		...
		<blockquote data-aos="fade-up">
			<q>âThe more that you read, the more things you will know. The more that you learn, the more places youâll go.â</q>
