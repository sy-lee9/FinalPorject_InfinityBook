	...
	<div class="container">
		<div class="row">
			<div class="section-header align-center">
				<h2 class="section-title" style="margin-botton:0px;">Notice-Write</h2>
			</div>
		</div>
	</div>
</section>
...
<section id="latest-blog" class="scrollspy-section padding-large" style="padding-top: 10px;padding-bottom: 10px;margin-bottom: 10px;">
	<div class="container">		
		<form id="notice" action="/admin/noticewrite.do" method="post">
			<table>			
				<tr>
					<td><input type="text" name="notice_title" placeholder="제목"/></td>
				</tr>
				<tr>
					<td>
