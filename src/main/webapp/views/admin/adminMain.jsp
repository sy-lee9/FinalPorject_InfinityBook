			  ...
			  <div id="all-genre" data-tab-content class="active">
			  	<div class="row">
				  	...
				  	<div id="products-grid" class="products-grid grid">
					  	...
					  	<figure class="product-style">
					  		<figcaption>
								<button type="button" onclick="location.href='#'" class="btn btn-outline-accent btn-accent-arrow" style="width:200px; height:150px;">감상문관리</button>
							</figcaption>
						</figure>
					
					  	<figure class="product-style">
					  		<figcaption>
								<button type="button" onclick="location.href='#'" class="btn btn-outline-accent btn-accent-arrow" style="width:200px; height:150px;">공지사항관리</button>
							</figcaption>
						</figure>
					
					  	<figure class="product-style">
					  		<figcaption>
								<button type="button" onclick="location.href='#'" class="btn btn-outline-accent btn-accent-arrow" style="width:200px; height:150px;">이벤트관리</button>
							</figcaption>
						</figure>
					  	...
					  	<figure class="product-style">
					  		<figcaption>
								<button type="button" onclick="location.href='#'" class="btn btn-outline-accent btn-accent-arrow" style="width:200px; height:150px;">코드관리</button>
							</figcaption>
						</figure>
					</div>
