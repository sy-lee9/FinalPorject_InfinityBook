...
<body>
	...
	<table>
		<tr>
			...
			<td>
				<c:if test="${jsp == 'trackerSearch.jsp'}">
					<input type="text" name="startDate" id="startDate" placeholder="독서 시작일"
		...
		<tr>
			...
			<td>
				<c:if test="${jsp == 'trackerSearch.jsp'}">
					<input type="text" name="readPage" id="readPage" placeholder="읽은 페이지 수" value="0"
						style="width:60px; margin-top: 20px;">
				</c:if>
				<c:if test="${jsp == 'trackerDetail.jsp'}">
					<input type="number" name="readPage" id="readPage" value="${readPage}"
						style="width:60px; margin-top: 20px;">
				</c:if>
				<input type="text" name="totalPage" id="totalPage" placeholder="총 페이지 수"
					style="width:60px; margin-top: 20px;" readonly>
			</td>
		</tr>
		<tr>
			<c:if test="${jsp == 'trackerSearch.jsp'}">
