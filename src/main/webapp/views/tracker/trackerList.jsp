		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<input type="button" value="추가" onclick="location.href='/mypage/trackerSearch.go'"
						style="float: right; bottom: 80px;">
						...
						<c:forEach items="${trackerList}" var="book">
							<div class="col-md-4" style="margin-bottom: 10%; height: 541px;">
								...
								<article class="column">
									...
									<div class="post-item">
										<h3 style="height: 20%;"><a
												href="/mypage/trackerDetail.go?trackerIdx=${book.trackerIdx}">${book.title}</a>
										</h3>
										<div class="meta-date" style="margin-bottom: 10; height:12%;">
											${book.author}</div>

										<div class="links-element">
											<div class="categories"
												style="float: left; font-size: 14; font-weight: 600;">
												${book.startDate}</div>
											<div class="categories"
												style="float: right; font-size: 14; font-weight: 600;">
												${book.endDate}</div>
											<div class="social-links"><progress value="${book.progress}" min="0"
													max="100" style=" border-radius: 50px;"></progress></div>
											<div class="categories"
												style="float: left; font-size: 14; font-weight: 600;">
												${book.progress}%</div>
											<div class="categories" style="float: right; font-size: 14;">
												${book.readPage} / ${book.totalPage} page</div>
										</div>
									</div>
