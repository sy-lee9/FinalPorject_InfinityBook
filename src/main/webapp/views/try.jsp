					...
					<div class="right-element">
						...
						<div class="action-menu">
							<div class="search-bar">
								...
								<form action="book/list" role="search" method="get" class="search-box">
									<input name ="text" class="search-field text search-input" placeholder="Search" type="search">
								</form>
							</div>
						</div>
					</div><!--top-right-->
				...
				<c:if test="${books.size() > 0 }">
					<c:forEach items="${books}" var="books">
						<figure class="product-style">
							<img src="${books.image}" alt="Books" class="product-item">
							<figcaption>
								<h3>${books.title}</h3>
								<p>${books.author}</p>discount
