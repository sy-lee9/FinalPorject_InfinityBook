...
@Service
@ServerEndpoint(value = "/alarm", configurator = ServerEndpointConfig.class) // websocket 연결점을 알려주는 어노테이션(webSocket을 활성화 시키는 요청)
public class AlarmsocketService {
	...
	public AlarmsocketService(AlarmService service) {
